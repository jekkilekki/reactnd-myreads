...
class UBookShelf extends Component {
  constructor(props) {
    super(props)
    this.state = {
      "books": [
  ...
  render() {
    const pastRead = this.state.books.filter((book) => (book.shelf === "read"))
              ...
              <li key={book.id}>
                <div className="book">
                  <div className="book-top">
                    <div className="book-cover hoverable" style={{ width: 128, height: 193, background: `url(${book.imageLinks.thumbnail})` }}></div>
